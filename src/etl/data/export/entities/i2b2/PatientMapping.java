...
public class PatientMapping extends Entity {
	...
	public PatientMapping(String str) throws Exception {
		super(str);
	}
	...
	public Map<String, List<PatientMapping>> generateObjectMappings(Set<Entity> entities, List<ColumnSequencer> sequencers) throws Exception {
		Map<String, List<PatientMapping>> objectMappings = new HashMap<String,List<PatientMapping>>();
		/*
	...
	*/
	...
	int x = 0;
	public void setMappedSequences(Map<String, List<PatientMapping>> oms, Set<Entity> builtEnts, List<ColumnSequencer> sequencers) 
	...
	private Map<String, Integer> createIndex(List<PatientMapping> list) {
