...
public class OLDCsvToI2b2TM extends JobType {
	...
	{
		Entity.ROOT_NODE = "Coronary Artery Risk Development in Young Adults";
		
		Entity.SOURCESYSTEM_CD = sourceSystem;;
	}
	
	public OLDCsvToI2b2TM(String str) throws Exception {
		super(str);
	...
	public void runJob() {
		...
		try {
			...
			// Mapping prep
			DataSource ds = new CSVDataSource("CSVFILE");
